...
%Assignment name
\subsection*{\center{\textbf{Exercise 7: application that writes data to the SD card}}}
...
\textbf{Behaviour:}
\begin{flushleft}
\lstinputlisting[language = JAVA]{./app/src/main/java/com/example/sdcard/MainActivity.java}
\end{flushleft}
